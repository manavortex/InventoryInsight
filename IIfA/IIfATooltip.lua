...
function IIfA:getMouseoverLink()
  ...
  elseif string.sub(name, 1, 14) == "MasterMerchant" then
    ...
    if mocGPGP then
      ...
      if name == 'MasterMerchantWindowList' or
        name == 'MasterMerchantWindowListContents' or
        name == 'MasterMerchantGuildWindowListContents' or
        name == 'MasterMerchantListingWindowListContents' or
        name == 'MasterMerchantPurchaseWindowListContents' or
        name == 'MasterMerchantReportsWindowListContents' or
        name == 'MasterMerchantFilterByNameWindowListContents' then
